		...
		<tr>
			<td>
				<form action="controladorMenuUsuarios" method="post">
					<input type="number" name="id_factura" value="${articulo.id_factura}" readonly="readonly"/> 
					<input type="number" name="id_producto" value="${articulo.id_producto}" readonly="readonly" /> 
					<input type="number" name="cantidad" value="${articulo.cantidad}" readonly="readonly"/>
