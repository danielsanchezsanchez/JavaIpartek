...
<div>
	...
	<p>
		...
		usuarios navegar y descargar aplicaciones (desarrolladas mediante
		Android SDK), juegos, música, libros, revistas y películas. También se
		pueden adquirir dispositivos móviles como ordenadores Chromebook,
		...
		dispositivo con Android a través de la aplicación móvil Play Store. Es
		posible también instalar estas aplicaciones directamente y sin
		...
		Google Music, el servicio fue renombrado a Google Play, como resultado
	...
	<p>En Google Play se encuentran disponibles tanto aplicaciones
		...
		aplicaciones pueden ser actualizadas automáticamente si el usuario así
		lo establece, o pueden hacerlo manualmente una a una. El 17 de marzo
		de 2009, alrededor de 2300 aplicaciones estaban disponibles en Android
		Market, de acuerdo con el director técnico de T-Mobile Cole Brodman.3
	...
	<p>Play Música es un servicio de almacenamiento y sincronización de
		...
		el almacenamiento gratuito de canciones propias hasta un total de 50
		000, que al sincronizarse en la nube, se podrá acceder desde cualquier
		punto. También permite escuchar música a través de streaming, servicio
		el cual se ofrece mediante suscripción. El servicio, es accesible vía
	...
	<p>Google creó Android Market el 28 de agosto de 2008 y lo puso a
		...
		2012, el servicio fue relanzado con una nueva apariencia, así como con
		un nuevo nombre, llamándose ahora Google Play y contando en ese
